...
function createRandomSentance() {
    ...
    const output = `${getRandomWord(names)} from ${getRandomWord(places)} ${getRandomWord(verbs)} ${getRandomWord(nouns)} ${getRandomWord(adverbs)} ${getRandomWord(details)}.`;

    console.log(output);
}

console.log('Hello, this is your first random generated senctace.');
createRandomSentance();
